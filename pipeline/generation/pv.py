...
def generer_pv(appel_offre, utilisateur=None):
    ...
    """
    logger.info("[PV] Debut generation du PV : %s", appel_offre.reference)
    ...
    logger.info("[PV] Contenu du PV prepare")
    ...
    pv.save()
    logger.info("[PV] Fichier PV enregistre")
    ...
    logger.info("[PV] Generation du PV terminee")
    return pv
